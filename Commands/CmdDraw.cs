...
namespace MCForge
{
	public class CmdDraw : Command
	{
		...
		{
			Player.SendMessage(p, "/draw <shape> <height> <baseradius> - Draw an object in game- Valid Types cones, spheres, and pyramids, hspheres (hollow sphere), and hpyramids (hollow pyramid)");
		}
